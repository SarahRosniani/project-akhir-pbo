...
function playGame() {
  ...
  if (virus_count < level.getCurrentLevel()) {
    ...
    vs[virus_count].initImg(
      m[getRndInteger(0, 3)],
      getRndInteger(400, 720),
      getRndInteger(10, 550)
    );
    virus_count++;
  ...
  for (let a = 0; a < virus_count; a++) {
    if (isvAttack[a]) {
      if (atv_pos[a] == 1) atv_y[a] += 2;
      else if (atv_pos[a] == 2) atv_x[a] -= 2;
      else if (atv_pos[a] == 3) atv_y[a] += 2;
      else if (atv_pos[a] == 4) atv_x[a] += 2;
  ...
  if (isAttack) {
    ...
    if (at_pos == 1) at_y -= 10;
    else if (at_pos == 2) at_x += 10;
    else if (at_pos == 3) at_y += 10;
    else if (at_pos == 4) at_x -= 10;
  ...
  if (
    hero.score > 0 &&
    hero.score % 120 == 0 &&
    level.getCurrentLevel() < level.maxLevel
  ) {
